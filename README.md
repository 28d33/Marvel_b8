...
### Overview
Learned the fundamentals of 3D printing and the complete workflow from model preparation to printing.

### Key Learnings
- Working principle of 3D printers
- Understanding STL files
- Slicing using Ultimaker
- Printer parameters:
  - Bed temperature, Infill density, Layer height,Print speed
- Printed an STL model under coordinator supervision
...
I created a weather application by integrating an external API to understand real-time data fetching.
[Weather_App](https://weather-api-woad-pi.vercel.app/)
...
![my_portfolio](images/portfolio.png)
---
...
![tinkerkad](images/thinkercad.png)
...
- Controlled LED through local network
 ![led toggle image](images/led1.jpeg)
 ![led toggle image](images/led2.jpeg)
...
### Overview
In this task, I worked on a **Linux troubleshooting challenge** called _Sad Servers_. The scenario was a “Command Line Murder Mystery,” where I had to investigate a crime using only Linux commands.
Helped me to practice Linux debugging through real-world scenarios.
